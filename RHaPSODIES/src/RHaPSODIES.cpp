...
namespace rhapsodies {
	...
	bool RHaPSODIES::RegisterShaders() {
		...
		S_oShaderRegistry.RegisterShader(
		...
		S_oShaderRegistry.RegisterProgram("textured", vec_shaders);

		vec_shaders.clear();
		vec_shaders.push_back("vert_vpos_uv");		
		vec_shaders.push_back("frag_textured_uint");		
		S_oShaderRegistry.RegisterProgram("textured_uint", vec_shaders);
	
		vec_shaders.clear();
		vec_shaders.push_back("vert_vpos_uv");		
		vec_shaders.push_back("frag_textured_uint8");		
		S_oShaderRegistry.RegisterProgram("textured_uint8", vec_shaders);

		vec_shaders.clear();
		vec_shaders.push_back("vert_vpos_uv");		
		vec_shaders.push_back("frag_textured_uint_diff");		
		S_oShaderRegistry.RegisterProgram("textured_uint_diff", vec_shaders);

		vec_shaders.clear();
		vec_shaders.push_back("vert_vpos");
		vec_shaders.push_back("frag_solid_green");		
		S_oShaderRegistry.RegisterProgram("vpos_green", vec_shaders);

		vec_shaders.clear();
		vec_shaders.push_back("vert_vpos");
		vec_shaders.push_back("frag_solid_blue");		
		S_oShaderRegistry.RegisterProgram("vpos_blue", vec_shaders);

		vec_shaders.clear();
		vec_shaders.push_back("vert_vpos");
		vec_shaders.push_back("frag_solid_colored");		
		S_oShaderRegistry.RegisterProgram("vpos_colored", vec_shaders);

		vec_shaders.clear();
		vec_shaders.push_back("vert_vpos_indexedtransform");
		vec_shaders.push_back("frag_solid_colored");
		vec_shaders.push_back("indexed_viewport");		
		S_oShaderRegistry.RegisterProgram("indexedtransform", vec_shaders);

		vec_shaders.clear();
		vec_shaders.push_back("vert_vpos_vnorm_indexedtransform");
		vec_shaders.push_back("frag_shaded_colored");
//		vec_shaders.push_back("indexed_viewport");		
		S_oShaderRegistry.RegisterProgram("shaded_indexedtransform", vec_shaders);

		vec_shaders.clear();
		vec_shaders.push_back("difference_score");
		S_oShaderRegistry.RegisterProgram("difference_score", vec_shaders);

		vec_shaders.clear();
		vec_shaders.push_back("reduction_x");
		S_oShaderRegistry.RegisterProgram("reduction_x", vec_shaders);

		vec_shaders.clear();
		vec_shaders.push_back("reduction_y");
		S_oShaderRegistry.RegisterProgram("reduction_y", vec_shaders);

		vec_shaders.clear();
		vec_shaders.push_back("generate_transforms");
		S_oShaderRegistry.RegisterProgram("generate_transforms", vec_shaders);
