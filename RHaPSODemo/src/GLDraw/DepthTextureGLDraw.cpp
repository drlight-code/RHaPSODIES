...
#include "DepthTextureGLDraw.hpp"
...
/*============================================================================*/
	DepthTextureGLDraw::DepthTextureGLDraw(GLuint texId,
	...
	DepthTextureGLDraw::~DepthTextureGLDraw() {
	}

/*============================================================================*/
/* IMPLEMENTATION                                                             */
/*============================================================================*/
	bool DepthTextureGLDraw::Do() {
	...
	bool DepthTextureGLDraw::GetBoundingBox(VistaBoundingBox &bb) {
